...
import { Wallet, Mail, Lock, User, ArrowRight, Sparkles, TrendingUp, Shield, CheckCircle2 } from "lucide-react"
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <CardContent className="space-y-5">
              ...
              <div className="pt-2 space-y-2">
                <p className="text-xs text-slate-400 font-medium mb-2">What you'll get:</p>
